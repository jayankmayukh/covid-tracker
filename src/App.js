...
class App extends Component{
    ...
    constructor(props){
        ...
        this.tabs = [
            ...
            },
            {
                ...
                pane: {
                    content: <Graph ref={(i)=>{this.Graph = i}}/>,
                    as: Container,
                    key: 1,
                }
            },
            {
                menuItem: (<Fragment key={2}>
                                <MenuMenu position='right'>
                                    ...
                                    <MenuItem fitted>
                                        <a target='_blank' href='https://github.com/jayankmayukh/covid-tracker'>
    ...
    plotGraph(country){
        let inp = [[[country],['Total Cases', 'Deaths', 'Recovered', 'Daily Cases',
        'Active Cases', 'Daily Recoveries', 'Daily Deaths'], 1, 0]];
    ...
    componentDidMount(){
        let requests = [
            fetch('https://corona-api.com/countries?include=timeline').then(async (data)=>{
